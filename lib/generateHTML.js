function generateEngineer(answers) {
  return `
    <div class="col-md card bg-dark mb-3" style="width: 18rem;">
    <div class="card-body">
      ...
      <ul class="list-group list-group-flush">
        ...
        <li class="list-group-item">
          Email: <a href="mailto:${answers.email}" class="card-link">${answers.email}</a>
        </li>
        <li class="list-group-item">
...
const headerHtml = `<!DOCTYPE html>
  <html lang="en">
    ...
    <body>
      ...
      <div class="row" style="width: 80rem; margin: auto;">`;
